...
class _ScreenState extends State<Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black, // Set background color to match your design
      body: SafeArea(
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  gradient: RadialGradient(
                    ...
                    radius: 0.64,
                 //   transform: GradientTransform(Matrix4.diagonal3Values(1.5, 0.8, 1.0)),
                  ),
                ),
                child: const Text(
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      gradient: RadialGradient(
                        colors: [Colors.black, Color(0xFF1E5E08)],
                        radius: 3.5,
                      ),
                    ),
                    child: const Center(
      ...
      decoration: const BoxDecoration(
        color:Colors.black, // card background (dark)
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Row(
            children: [
              Container(
                width: 7,
                height: 7,
                color: Colors.red, // red square icon
              ),
          ...
          const Text(
            ...
            style: TextStyle(
              ...
              fontSize: 20,
              fontWeight: FontWeight.bold,
              fontFamily: 'Courier', // optional to match digital style
            ),
          ),
        ],
      ),
